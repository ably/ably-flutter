...
class RealtimeHistoryTest extends TestWidget {
  const RealtimeHistoryTest(TestDispatcherState dispatcher) : super(dispatcher);

  @override
  TestWidgetState<TestWidget> createState() => RealtimeHistoryTestState();
}

class RealtimeHistoryTestState extends TestWidgetState<RealtimeHistoryTest> {
  @override
  Future<void> test() async {
    ...
    final historyWithStartAndEnd = await _history(
        channel, RealtimeHistoryParams(start: time1, end: time2));
