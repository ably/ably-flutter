...
class RealtimePresenceEnterUpdateLeaveTest extends TestWidget {
  const RealtimePresenceEnterUpdateLeaveTest(TestDispatcherState dispatcher)
      : super(dispatcher);

  @override
  TestWidgetState<TestWidget> createState() =>
      RealtimePresenceEnterUpdateLeaveTestState();
}

class RealtimePresenceEnterUpdateLeaveTestState
    extends TestWidgetState<RealtimePresenceEnterUpdateLeaveTest> {
