...
NSString *const AblyPlatformMethod_restAuthCreateToken= @"restAuthCreateToken";
...
NSString *const AblyPlatformMethod_realtimeAuthCreateToken= @"realtimeAuthCreateToken";
