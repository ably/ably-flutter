...
public class PushNotificationEncoders: NSObject {
    @objc
    public static let encodeDeviceDetails: (ARTDeviceDetails) -> [String: Any] = { device in
        [
    ...
    @objc
    public static let encodeDevicePushDetails: (ARTDevicePushDetails) -> [String: Any] = { devicePushDetails in
        [
    ...
    @objc
    public static let encodeLocalDevice: (ARTLocalDevice) -> [String: Any] = { device in
        [
    ...
    @objc
    public static let encodePushChannelSubscription: (ARTPushChannelSubscription) -> [String: Any] = { subscription in
        [
    ...
    @objc
    public static let encodeUNNotificationSettings: (UNNotificationSettings) -> [String: Any] = { settings in
...
//        }
    ...
    @objc
    public static let encodeRemoteMessage: (RemoteMessage) -> [String: Any] = { remoteMessage in
        var dictionary = [String: Any]()
