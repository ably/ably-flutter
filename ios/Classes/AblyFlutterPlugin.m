...
static const FlutterHandler _clearPlatformInstances = ^void(AblyFlutterPlugin *const plugin, FlutterMethodCall *const call, const FlutterResult result) {
...
-(instancetype)initWithChannel:(FlutterMethodChannel *const)channel
    ...
    _handlers = @{
        ...
        AblyPlatformMethod_clearPlatformInstances: _clearPlatformInstances,
