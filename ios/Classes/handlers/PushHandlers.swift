...
public class PushHandlers: NSObject {
    ...
    @objc
    public static let getNotificationSettings: (_ plugin: AblyFlutterPlugin, _ call: FlutterMethodCall, _ result: @escaping FlutterResult) -> Void = { plugin, call, result in
