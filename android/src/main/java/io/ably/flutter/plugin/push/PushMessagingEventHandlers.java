 ...
 */
public final class PushMessagingEventHandlers {
  private static final String TAG = PushMessagingEventHandlers.class.getName();
  public static final String PUSH_ON_MESSAGE_RECEIVED =
      "io.ably.ably_flutter.PUSH_ON_MESSAGE_RECEIVED";
  public static final String PUSH_ON_BACKGROUND_MESSAGE_RECEIVED =
      "io.ably.ably_flutter.PUSH_ON_BACKGROUND_MESSAGE_RECEIVED";
  public static final String PUSH_ON_BACKGROUND_MESSAGE_PROCESSING_COMPLETE =
      "io.ably.ably_flutter.PUSH_ON_BACKGROUND_MESSAGE_COMPLETE";
  ...
  public static void sendMessageToFlutterApp(
  ...
  private static class BroadcastReceiver extends android.content.BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      switch (action) {
        case PUSH_ON_MESSAGE_RECEIVED:
          sendRemoteMessageToDartSide(
              PlatformConstants.PlatformMethod.pushOnMessage, message, () -> finish(context));
          break;
        case PUSH_ON_BACKGROUND_MESSAGE_RECEIVED:
          sendRemoteMessageToDartSide(
              PlatformConstants.PlatformMethod.pushOnBackgroundMessage,
              message,
              () -> finish(context));
          break;
        default:
    ...
    // Used to send the RemoteMessage, which may (or may not) contain Data and
    // RemoteMessage.Notification
    private void sendRemoteMessageToDartSide(
        String methodName, RemoteMessage remoteMessage, CompletionCallback callback) {
    ...
    void finish(final Context context) {
      final Intent backgroundMessageCompleteIntent =
          new Intent(PUSH_ON_BACKGROUND_MESSAGE_PROCESSING_COMPLETE);
