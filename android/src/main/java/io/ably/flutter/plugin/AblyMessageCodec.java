...
public class AblyMessageCodec extends StandardMessageCodec {
    ...
    private PlatformClientOptions decodeClientOptions(Map<String, Object> jsonMap) {
        ...
        readValueFromJson(jsonMap, PlatformConstants.TxClientOptions.fallbackHosts, v -> {
             clientOptions.fallbackHosts = Arrays.copyOf(((ArrayList<?>)v).toArray(), ((ArrayList<?>)v).size(), String[].class);
        });
