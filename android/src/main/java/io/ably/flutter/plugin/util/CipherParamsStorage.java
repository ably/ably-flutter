 ...
 * [CipherParamsStorage.from]. This only works when both methods are called on the same instance of
 * CipherParamsStorage, and not between app restarts.
 */
public class CipherParamsStorage {
  ...
  /**
   * Gets the [CipherParams] instance from the Integer handle. Use this to get a CipherParams when
   * the Dart side provides only an Integer representing the CipherParams.
   *
   * @param handle
   * @return
   */
